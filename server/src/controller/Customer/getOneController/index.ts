...
const customerGetOneController = async (req: Request, res: Response) =>{
    try {
        //request parameters
        ...
        //dao
        const response = {payload: "customer get one response", document};
...
export default customerGetOneController;